...
The Samos web interface requires Node 8.10.0 or higher, together with NPM 5.6 or higher.
...
While event.samos.io is not working, we will have to run the purchase API locally.
