...
@Component({
  selector: 'app-send-samos',
  templateUrl: './send-samos.component.html',
  styleUrls: ['./send-samos.component.scss']
})
export class SendSamosComponent implements OnInit, OnDestroy {
