...
A REST API implemented in Go is available, see [Skycoin REST API Client Godoc](https://godoc.org/github.com/samoslab/samos/src/gui#Client).
...
```json
{
    ...
    "peers": [
    {
        "address": "35.157.164.126:8858",
        "height": 2760
    },
    {
        "address": "63.142.253.76:8858",
        "height": 2760
    },
    ]
}
