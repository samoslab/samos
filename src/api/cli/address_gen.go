...
import (
	...
	bip39 "github.com/samoslab/samos/src/cipher/go-bip39"
...
func addressGenCmd() gcli.Command {
	...
	return gcli.Command{
		Name:        name,
		Usage:       "Generate samos or bitcoin addresses",
		Description: "",
		Flags: []gcli.Flag{
			gcli.IntFlag{
				Name:  "count,c",
			...
			gcli.BoolFlag{
				Name:  "bitcoin,b",
				Usage: "Output the addresses as bitcoin addresses instead of samos addresses",
			},
			gcli.BoolFlag{
				Name:  "hex,x",
