...
import (
	...
	"github.com/samoslab/samos/src/daemon/pex"
	"github.com/samoslab/samos/src/util/iputil"
...
func getMessageConfigs() []MessageConfig {
	return []MessageConfig{
		...
		NewMessageConfig("GETTT", GetTrustMessage{}),
		NewMessageConfig("GIVTT", GiveTrustMessage{}),
		NewMessageConfig("ANNTT", AnnounceTrustMessage{}),
	}
}
