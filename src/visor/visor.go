...
import (
	...
	"github.com/samoslab/samos/src/util/droplet"
	"github.com/samoslab/samos/src/util/utc"
	"github.com/samoslab/samos/src/visor/blockdb"
...
//Samos transactions are smaller than Bitcoin transactions so skycoin has
